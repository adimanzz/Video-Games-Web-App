# -*- coding: utf-8 -*-
"""
Created on Mon Aug  3 10:17:47 2020
...
# Model
model = SentimentNet(max_length, vocab_size, embedding_dim, num_classes = 3)
model = model.forward()
...
checkpoint = ModelCheckpoint('Models/model5-{epoch:03d}-{accuracy:03f}-{val_accuracy:03f}.h5', verbose=1, monitor='val_accuracy',save_best_only=True, mode='auto') 
